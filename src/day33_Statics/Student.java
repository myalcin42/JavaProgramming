...
public class Student {
    ...
    public String name;
    public char gender;
    public int age; // public static diye oluşturursak kaç tane obje olduğu önemli olmaksızın bütün hepsi aynı yaş data değerine sahip olur bu yüzden instance variable oluşturuyoruz ki her bir obje için ayrı birer kopya oluşsun
    ...
    public Student(String name, char gender, int age, int studentID, char grade) {
        this(name, gender, age, studentID); // parantez içerisinde mouse tutup (hower yaparak) Ctrl + Space yaparsan intellij opsiyonları gösterir
        this.grade = grade;
    }
