...
public class EmployeeObjects {
    ...
    //    Employee employee = new Employee("Ali",30,'M',42,"SDET",145000.00); abstract classlardan object oluşturulmaz hata verir ama abstract class inherit edilebilir final classlardan inherit edilemez
