...
public class BuildInFunctionalInterfaces2 {
    ...
    public static void main(String[] args) {
        ...
        //crate a function that takes first and last names and prints the formatted full name
        ...
        //3. create a function that takes a list of Integer and a list of String and a list of Integer and merge them into a map
         /*
        names ==> {"Josh", "Daniel"}
        score ==> {100, 110}
