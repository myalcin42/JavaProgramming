...
//        //mesela bu Mapteki bütün keylere ulaşmak istersem
//        Set<String> keys = students.keySet(); //keySet() metodu bütün keylere ulaşır ve sonucu Set döndürür çünkü Set interface de duplicate kabul etmez
//
...
//        }
       ...
       // Collection<Integer> scores = students.values();
        ...
        //removeIf metodu Iterable interfaceinden geldiği için Map te kullanılmaz

        System.out.println("============   =================   ================");


        //entrySet() bu metot her bir element çiftine ayı anda ulaşmamızı sağlar yani key = value olarak
